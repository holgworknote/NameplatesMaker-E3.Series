...
namespace Core
{
	...
	public class E3RectangleDrawer : IE3Drawer
	{
		...
		public void Execute(e3Job e3job, e3Sheet e3sheet)
		{
			...
			{
				string errMsg = "Возникли проблемы при отрисовке геометрии в E3.Series";
	...
	public class E3TextFieldDrawer : IE3Drawer
	{
		...
		public void Execute(e3Job e3job, e3Sheet e3sheet)
		{
			...
			{
				string errMsg = "Возникли проблемы при отрисовке текстового поля в E3.Series";
				throw new Exception(errMsg, ex);
			}
		}
	}
	public class E3PlateDrawer : IE3Drawer
	{
		...
		public void Execute(e3Job e3job, e3Sheet e3sheet)
		{
			...
			{
				string errMsg = "Возникли проблемы при отрисовке таблички в E3.Series";
				throw new Exception(errMsg, ex);
			}
		}
	}
	public class E3SheetDrawer : IE3Drawer
	{
		...
		public void Execute(e3Job e3job, e3Sheet e3sheet)
		{
			...
			{
				string errMsg = "Возникли проблемы при отрисовке листа в E3.Series";
				throw new Exception(errMsg, ex);
			}
		}
	}
